...
const consumerKey = "0jBv1sPa5-mmCtGWVN4uiw=="
const consumerSecret = "zEd9fQhVES98aInT2jweUdstJmaH-l1m6ougxP164vM="
...
const startVideo = () => {
  conference
    ...
    .then((res) => {console.log("resvideo",res) })
    .catch((err) => {
      console.error(err);
    });
};
...
const startAudio = () => {
  conference
    ...
    .then((res) => {console.log("ResAudio",res) })
    .catch((err) => {
      console.error(err);
    });
};
